...
function renderGame() {
  if (gameStatus != 0 && allowStart == 1) {return};
  ...
  if (minesAmount > 0 && minesAmount <= 24) {
    ...
    outputMessage = "<b>Game Started</b>"
    outputMessageEl.innerHTML = outputMessage
    allowStart = 0;
    allowClicking = 1;
    gameStatus = 1;
  } else {
    outputMessage = "<b>Error</b>: Mines Value Not Accepted";
    outputMessageEl.innerHTML = outputMessage;
  }
}
...
function lose() {
  outputMessageEl.innerHTML = "<b>OH NO! You lost :(</b>"
...
function win() {
  outputMessageEl.innerHTML = "<b>Congratulations You WIN!</b>"
